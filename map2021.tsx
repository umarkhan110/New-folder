...
import geoJSONData from './ParkingTic2021.json';
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      ...
      //         15,
      //       ],
      //       "circle-color": "#F76260", // Set the color to red for all points in this layer
      //       "circle-opacity": 0.7,
      //       "circle-stroke-width": 1,
      //       "circle-stroke-color": "white",
      //     },
      //     layout: {},
      //     filter: [">", ["get", "# OF CITATIONS"], 800], // Set a filter to display only points with "# OF CITATIONS" greater than 5
      //   });
      // }else{
      // map.addLayer({
      //   id: "high-citation-points",
      ...
      //   },
      //   layout: {},
      //   filter: [">", ["get", "# OF CITATIONS"], 400], // Set a filter to display only points with "# OF CITATIONS" greater than 5
      // });
    ...
    // }
      ...
      const maxCitationObj = filteredfeatures.reduce((maxObj, obj) => {
        if (obj.properties["# OF CITATIONS"] > maxObj.properties["# OF CITATIONS"]) {
            return obj;
        } else {
            return maxObj;
        }
              ...
              const allthelineitems = uniqueArray.map(
                (eachdeath) => {
                  if (maxCitationObj.properties) {
                    // console.log(maxCitationObj.properties)
                    let address = maxCitationObj.properties["Full_Address"];
                    if (address === "N/A") {
                      address = "";
                    }
                    ...
                    let dfs =
                      maxCitationObj.properties["YEAR"];
                    if (dfs === "N/A") {
                      dfs = "";
                    }
                  ...
                  <li class="leading-none my-1">
                    ...
                    ${
                      dfs
                        ? `<div class="discounted">Year: ${dfs}</div>`
                        : ""
                    }
                  </li>
                `;
